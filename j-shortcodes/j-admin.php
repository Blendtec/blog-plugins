...
$g_JAY__plugin_directory_url = WP_PLUGIN_URL . '/j-shortcodes/';
//---------------------------------------------------------------------------
            ...
            <td style="background-color:white;" align="center" valign="middle">
               <div align="center">theme="<b><?php echo $theme_name; ?></b>"<br />
                  ...
                  <div style="background-color:#f0f0f0;padding:3px;margin:3px;border:1px solid #6c966a;">
                     <?php echo $label; ?><input type="hidden" name="jquery_themes[<?php echo $theme_name; ?>]" value="0" /><input type="checkbox" style="float:none;<?php echo $input_extra_style; ?>" value="1" name="jquery_themes[<?php echo $theme_name; ?>]" <?php if ($val) echo ' checked="checked"'; ?> <?php if( isset( $is_disabled ) ) { echo $is_disabled; } ?> />
                  <div>
               </div>
            </td>
         <?php endforeach; ?>
