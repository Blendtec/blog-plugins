...
function wp_rp_prepare_admin_connect_notice() {
	...
	if ($meta['show_turn_on_button'] && !$meta['turn_on_button_pressed'] && !$meta['blog_id'] && $meta['new_user']) {
		wp_register_style( 'wp_rp_connect_style', plugins_url('related-posts/static/css/connect.css') );
		wp_register_script( 'wp_rp_connect_js', plugins_url('related-posts/static/js/connect.js') );
